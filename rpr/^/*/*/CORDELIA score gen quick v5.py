...
#GEN COMMAND
shutil.copy2(CORDELIA_path + '_scripts/_cmd/command.txt', project_folder + '__' + project_name + '.command')
shutil.copy2(CORDELIA_path + '_scripts/_cmd/command_quick.txt', project_folder + '__' + project_name + '_quick.command')
...
shutil.copy2(CORDELIA_path + '_core/' + CORDELIA_csd_name_ext, project_folder + csd_name_ext)


CORDELIA_csd_full = 'cordelia-full.csd'
full_path = project_folder + project_name + '_full' + '.csd'
shutil.copy2(CORDELIA_path + '_core/' + CORDELIA_csd_full, full_path)
